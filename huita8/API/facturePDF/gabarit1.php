...
$pdf->template['client']['margin'] = array(3, 0, 0, 10);
$pdf->template['client']['lineHeight'] = 10;
$pdf->template['client']['color'] = array('r'=>150, 'g'=>150, 'b'=>150);
// pied de page
...
$pdf->template['productHead']['color'] = array('r'=>17, 'g'=>84, 'b'=>25);
$pdf->template['productHead']['margin'] = array(6, 2, 0, 0);
...
$pdf->template['product']['backgroundColor'] = array('r'=>240, 'g'=>240, 'b'=>240);
...
$pdf->template['totalHead']['backgroundColor'] = array('r'=>35, 'g'=>163, 'b'=>50);
...
$pdf->template['traitEnteteProduit']['backgroundColor'] = array('r'=>35, 'g'=>163, 'b'=>50);
$pdf->template['traitEnteteProduit']['margin'] = array(0, 0, 0, 0);
?>