document.addEventListener("DOMContentLoaded", function () {	//document is loaded
	...
	var img = document.querySelectorAll(".vignette_img_min").forEach(function(element){
		element.addEventListener('click', function(){//add the click listener

		lightBox("https://moncadencierperso.com/?", '');//associate the function executed when the user click on it
	});
	})
